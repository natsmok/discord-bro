        ...
        if response.status_code == 200:
            ...
            if player_data:
                ...
                if discord_id:
                    ...
                    gif_url = "https://i.pinimg.com/originals/e6/cd/44/e6cd44032a6997429027e4972386fd87.gif"
                    embed.set_image(url=gif_url)

                    embed.set_footer(text=f"ค้นหาข้อมูลโดย {channel.guild.name}", icon_url=channel.guild.icon.url)
                    embed.set_author(name="FiveM Player Checker", icon_url="https://i.pinimg.com/736x/1d/3b/82/1d3b82e24a024e983b67d97d907730cf.jpg")
